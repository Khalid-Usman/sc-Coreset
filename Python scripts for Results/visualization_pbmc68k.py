...
X_full = np.loadtxt('/home/khalid/Datasets/pbmc68k_fbpca50.txt', delimiter=',')
Y_full = np.loadtxt('/home/khalid/Datasets/pbmc68k_labels.txt', delimiter=',').astype(int)
printFrequencies(Y_full)

coresetSize = 5000

fileName = "/home/khalid/Datasets/pbmc68k_fbpca50.txt"
...
###   Sc-Coreset  ######
print('SC-Coreset')
coreset_idx = np.loadtxt('/home/khalid/Datasets/pbmc68k_coreset_5000_idx.txt', delimiter=',').astype(int)
coreset_idx -= 1
