...
X_full = np.loadtxt('/home/khalid/Datasets/moca_fbpca100.txt', delimiter=',')
...
Y_full = np.loadtxt('/home/khalid/Datasets/moca_labels.txt', delimiter=',').astype(int)
...
###   Sc-Coreset  ######
print('SC-Coreset')
coreset_idx = np.loadtxt('/home/khalid/Datasets/moca_coreset_5000_idx.txt', delimiter=',').astype(int)
coreset_idx -= 1
