...
def measurePerformance(y_test, y_pred, method):
    ...
    plt.show()
    filepng = 'pbmc68k_confusion_' + method + '.png'
    filepdf = 'pbmc68k_confusion_' + method + '.pdf'
...
X_full = np.loadtxt('/home/khalid/Datasets/neurons_fbpca100.txt', delimiter=',')
...
Y_full = np.loadtxt('/home/khalid/Datasets/neurons_label.txt', delimiter=',').astype(int)
printFrequencies(Y_full)

coresetSize = 5000

fileName = "/home/khalid/Datasets/neurons_fbpca100.txt"
...
###   Sc-Coreset  ######
print('SC-Coreset')
coreset_idx = np.loadtxt('/home/khalid/Datasets/neurons_coreset_5000_idx.txt', delimiter=',').astype(int)
coreset_idx -= 1
