...
%
    ...
    fileName = strcat('/home/khalid/Datasets/moca_coreset_', num2str(m), '.txt')
    idxName = strcat('/home/khalid/Datasets/moca_coreset_idx_', num2str(m), '.txt')
    dlmwrite(fileName, X, 'delimiter', ',');
    dlmwrite(idxName, Idx, 'delimiter', ',');
