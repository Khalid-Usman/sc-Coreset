...
%A = dlmread('/home/khalid/Datasets/pbmc68k_fbpca50.txt', ' ');
%A = dlmread('/home/khalid/Datasets/pbmc68k_preprocessed.txt', ',');
A = dlmread('/home/khalid/Datasets/pbmc68k_seurat_preprocessed_withoutHeadet.txt', ',');
A = sparse(A);
n = size(A,1);
nn = ceil(n/4)
size(A)
...
%M = [100 200 300 400 500 600 700 800 900 1000 2000 5000 10000];
M = [5000];
...
%
    ...
    fileName = strcat('/home/khalid/Datasets/pbmc68k_beforePCA_coreset_', num2str(m), '.txt')
    idxName = strcat('/home/khalid/Datasets/pbmc68k_beforePCA_coreset_idx_', num2str(m), '.txt')
