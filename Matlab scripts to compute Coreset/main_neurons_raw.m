...
%
    ...
    fileName = strcat('/home/khalid/Datasets/neurons_HVG1000_beforePCA_coreset_', num2str(m), '.txt')
    %indexName = strcat('/home/khalid/Datasets/neurons_coreset_idx_', num2str(m), '.txt')
